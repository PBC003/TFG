export const en = {
  ...
  auth: {
    loginTitle: 'Log in',
    loginSubtitle: 'Sign in with your University of Oviedo institutional email or your UO identifier.',
    registerTitle: 'Student registration',
    registerSubtitle: 'Public registration creates STUDENT accounts.',
    email: 'Institutional email or UO',
    password: 'Password',
    ...
    lastName: 'Last name',
    submitLogin: 'Sign in',
    loginIdentifierHint: 'You can use uoXXXXXX or uoXXXXXX@uniovi.es.',
  ...
  quizzes: {
    ...
    audience: {
      ...
      groups: 'Restricted to {{count}} group(s)',
    },
    table: {
      title: 'Quiz',
      status: 'Status',
    ...
    fields: {
      ...
      assignedGroupsHelper: 'If you do not select any groups, the quiz will be visible to all eligible students. If you select groups, only those groups will see it.',
    ...
    simulation: {
      ...
      subtitle: 'Preview mode for teachers. This attempt does not count towards analytics or student history.',
      back: 'Back to quizzes',
      restart: 'Restart simulation',
      submitSuccess: 'Simulation submitted successfully.',
    },
    pagination: {
  ...
  quizAnalytics: {
    ...
    subtitle: 'Review attempt-level performance, question difficulty and exportable results.',
    backToQuizzes: 'Back to quizzes',
    exportCsv: 'Export CSV',
    exportStats: 'Export statistics',
    exportSuccess: 'CSV exported successfully.',
    empty: 'This quiz has no recorded attempts yet.',
    distributionTitle: 'Score distribution',
    attemptsTitle: 'Recorded attempts',
    questionStatsTitle: 'Question statistics',
    detailTitle: 'Attempt detail',
    viewDetail: 'View detail',
    attemptsSubtitle: 'Search by participant and review the detail of each recorded attempt.',
    searchPlaceholder: 'Search by participant name',
    searchEmpty: 'There are no attempts matching the current search.',
    participantValue: 'Participant: {{value}}',
    attemptValue: 'Attempt {{current}}',
    startedAtValue: 'Started: {{value}}',
    submittedAtValue: 'Submitted: {{value}}',
    rawScoreValue: 'Score: {{earned}} / {{max}}',
    scoreValue: 'Score: {{earned}} / {{max}} · {{score}} / 10',
    scoreCompactValue: '{{earned}} / {{max}} · {{score}} / 10',
    submittedAnswerLabel: 'Submitted answer',
    correctAnswerLabel: 'Correct answer',
    submittedAnswerValue: 'Submitted answer: {{value}}',
    correctAnswerValue: 'Correct answer: {{value}}',
    pointsPerQuestionValue: 'Points: {{earned}} / {{max}}',
    questionTitle: 'Question {{index}}',
    summary: {
      totalAttempts: 'Total attempts',
      uniqueParticipants: 'Unique participants',
      averageScore: 'Average score / 10',
      bestScore: 'Best score / 10',
      worstScore: 'Worst score / 10',
      averageCompletionMinutes: 'Avg. time (min)',
    ...
    distributionCount: '{{count}} attempts',
    distributionBuckets: {
      failed: 'Fail',
      pass: 'Pass',
      notable: 'Notable',
    ...
    pagination: {
      rowsPerPage: 'Attempts per page',
    },
  },
  quizHistory: {
    title: 'My quiz history',
    subtitle: 'Review the quizzes you have already started or submitted.',
    empty: 'There is no recorded quiz history for your account yet.',
    openQuiz: 'Open quiz',
  ...
  groups: {
    ...
    subtitle: 'Create your own groups, assign students, and use them to restrict quiz visibility.',
    ...
    search: 'Search by name, description, or student',
    ...
    validation: {
      ...
      nameHelper: 'Use a clear and unique name with at least 3 characters.',
    },
    fields: {
      name: 'Group name',
      description: 'Description',
      students: 'Students',
      studentsPlaceholder: 'Select students for this group',
      studentsHelper: 'You can search by name or UO identifier and select multiple students.',
    },
    table: {
      name: 'Group',
      students: 'Students',
  ...
  forms: {
    validation: {
      ...
      unioviLogin: 'Enter a valid institutional email or your UO identifier (uoXXXXXX).',
