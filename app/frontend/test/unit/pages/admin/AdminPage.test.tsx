...
vi.mock("../../../../src/pages/admin/components/AdminToolbar", () => ({
  AdminToolbar: ({
    totalVisible,
    onSearchChange,
...
vi.mock("../../../../src/pages/admin/components/AdminUsersTable", () => ({
  AdminUsersTable: ({
    users,
    onEdit,
    onResetPassword,
...
vi.mock("../../../../src/pages/admin/components/AdminUserCards", () => ({
  AdminUserCards: ({
    users,
    onEdit,
    onResetPassword,
...
vi.mock(
  "../../../../src/pages/admin/components/dialogs/UserEditDialog",
  () => ({
    UserEditDialog: ({
      open,
      user,
...
vi.mock(
  "../../../../src/pages/admin/components/dialogs/UserPasswordDialog",
  () => ({
    UserPasswordDialog: ({
      open,
      user,
...
vi.mock(
  "../../../../src/pages/admin/components/dialogs/UserConfirmDialog",
  () => ({
    UserConfirmDialog: ({
      open,
      title,
